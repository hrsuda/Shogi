...
#0 hisha 1
        w = weight_init_std * cp.random.randn(2*2*14*len(self.filter_positions_1[0]))
        b = weight_init_std * cp.random.randn(9,9)
        self.W_params.append(w)
        self.b_params.append(b)
...
#4 Last 1
        w = weight_init_std * cp.random.randn(81+81+81+81+14*2*2, 100)/(1848+1848+560+504)**0.5
        b = weight_init_std * cp.random.randn(100)/(1848+1848+560+504)**0.5
        self.W_params.append(w)
        self.b_params.append(b)
        self.layers.append(Affine(w,b))
#5 Rule 1
...
#6 hisha 2
        w = weight_init_std * cp.random.randn(4*len(self.filter_positions_1[0]))/(81+81+81+81+14*2*2)**0.5
        b = weight_init_std * cp.random.randn(9,9)/(81+81+81+81+14*2*2)**0.5
        self.W_params.append(w)
        self.b_params.append(b)
        self.layers.append(Convolution_alpha_with_Sigmoid( w, b, self.filter_positions_1, stride=1, pad=8))

#7 kaku 2
        w = weight_init_std * cp.random.randn(4*len(self.filter_positions_2[0]))/(81+81+81+81+14*2*2)**0.5
        b = weight_init_std * cp.random.randn(9,9)/(81+81+81+81+14*2*2)**0.5
        self.W_params.append(w)
        self.b_params.append(b)
        self.layers.append(Convolution_alpha_with_Sigmoid( w, b, self.filter_positions_2, stride=1, pad=8))
...
#8 keima 2
        w = weight_init_std * cp.random.randn(4*len(self.filter_positions_3[0]))/(81+81+81+81+14*2*2)**0.5
        b = weight_init_std * cp.random.randn(9,9)/(81+81+81+81+14*2*2)**0.5
        self.W_params.append(w)
        self.b_params.append(b)
        self.layers.append(Convolution_alpha_with_Sigmoid( w, b, self.filter_positions_3, stride=1, pad=8))
...
#9 sonota 2
        w = weight_init_std * cp.random.randn(4,3,3)/(81+81+81+81+14*2*2)**0.5
        b = weight_init_std * cp.random.randn(9,9)/(81+81+81+81+14*2*2)**0.5
        self.W_params.append(w)
        self.b_params.append(b)
        self.layers.append(Convolution_with_Sigmoid( w, b, stride=1, pad=1))
...
#10 Last 2
        w = weight_init_std * cp.random.randn(81+81+81+81+100, 50)/(4*33*2 + 4*10 + 4*9 + 4*14)**0.5
        b = weight_init_std * cp.random.randn(50)/(4*33*2 + 4*10 + 4*9 + 4*14)**0.5
        self.W_params.append(w)
        self.b_params.append(b)
        self.layers.append(Affine(w,b))
...
#12 hisha 3
        w = weight_init_std * cp.random.randn(4*len(self.filter_positions_1[0]))/(4*33*2 + 4*10 + 4*9)**0.5
        b = weight_init_std * cp.random.randn(9,9)/(4*33*2 + 4*10 + 4*9)**0.5
        self.W_params.append(w)
        self.b_params.append(b)
        self.layers.append(Convolution_alpha_with_Sigmoid( w, b, self.filter_positions_1, stride=1, pad=8))

#13 kaku 3
        w = weight_init_std * cp.random.randn(4*len(self.filter_positions_2[0]))/(4*33*2 + 4*10 + 4*9)**0.5
        b = weight_init_std * cp.random.randn(9,9)/(4*33*2 + 4*10 + 4*9)**0.5
        self.W_params.append(w)
        self.b_params.append(b)
        self.layers.append(Convolution_alpha_with_Sigmoid( w, b, self.filter_positions_2, stride=1, pad=8))
...
#14 keima 3
        w = weight_init_std * cp.random.randn(4*len(self.filter_positions_3[0]))/(4*33*2 + 4*10 + 4*9)**0.5
        b = weight_init_std * cp.random.randn(9,9)/(4*33*2 + 4*10 + 4*9)**0.5
        self.W_params.append(w)
        self.b_params.append(b)
        self.layers.append(Convolution_alpha_with_Sigmoid( w, b, self.filter_positions_3, stride=1, pad=8))
...
#15 sonota 3
        w = weight_init_std * cp.random.randn(4,3,3)/(4*33*2 + 4*10 + 4*9)**0.5
        b = weight_init_std * cp.random.randn(9,9)/(4*33*2 + 4*10 + 4*9)**0.5
        self.W_params.append(w)
        self.b_params.append(b)
        self.layers.append(Convolution_with_Sigmoid( w, b, stride=1, pad=1))
...
#16 Last 3
        w = weight_init_std * cp.random.randn(81+81+81+81+50, 1)/(324 + 100)**0.5
        b = weight_init_std * cp.random.randn(1)/(324 + 100)**0.5
        self.W_params.append(w)
        self.b_params.append(b)
        self.layers.append(Affine(w,b))
    ...
    def predict(self, x):
        ...
        x_1234 = cp.array([x1,x2,x3,x4]).transpose(1,0,2).reshape(-1,4,9,9)
        ...
        x = cp.concatenate([x1,x2,x3,x4,x],axis=1)
    ...
    def gradient(self, x, t):
        ...
        dout6789 = cp.sum(cp.array([dout6,dout7,dout8,dout9]),axis=0)/5.
...
class ShogiLayerNet3(object):
    def __init__(self, weight_init_std=0.1):
        ...
        w = weight_init_std * cp.random.randn(1,2*2*14,3,3)
        b = weight_init_std * cp.random.randn(9,9)
        self.W_params.append(w)
        self.b_params.append(b)
        ...
        w = weight_init_std * cp.random.randn(1,2*2*14,9,9)
        b = weight_init_std * cp.random.randn(9,9)
        self.W_params.append(w)
        self.b_params.append(b)
        ...
        w = weight_init_std * cp.random.randn(1,2,3,3)
        b = weight_init_std * cp.random.randn(9,9)
        self.W_params.append(w)
        self.b_params.append(b)
        self.layers.append(Select(layer=Convolution_original, ind=0, W=w, b=b, stride=1, pad=1))

        w = weight_init_std * cp.random.randn(1,2,9,9)
        b = weight_init_std * cp.random.randn(9,9)
        self.W_params.append(w)
        self.b_params.append(b)
        self.layers.append(Select(layer=Convolution_original, ind=1, W=w, b=b, stride=1, pad=4))
        # w = weight_init_std * cp.random.randn(9*9*2*2*14,9*9)
        # b = weight_init_std * cp.random.randn(9*9)
        # self.W_params.append(w)
        # self.b_params.append(b)
        ...
        w = weight_init_std * cp.random.randn(2*9*9+2*2*14,50)
        b = weight_init_std * cp.random.randn(50)
        self.W_params.append(w)
        self.b_params.append(b)
        self.layers.append(Affine(w, b))
        ...
        w = weight_init_std * cp.random.randn(50,25)
        b = weight_init_std * cp.random.randn(25)
        self.W_params.append(w)
        self.b_params.append(b)
        self.layers.append(Affine(w, b))
        ...
        w = weight_init_std * cp.random.randn(25,1)
        b = weight_init_std * cp.random.randn(1)
        self.W_params.append(w)
        self.b_params.append(b)
        self.layers.append(Affine(w, b))
